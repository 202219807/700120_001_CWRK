...
public:
	...
	ReflectionShader(const ReflectionShader& other) = default;
	ReflectionShader(ReflectionShader&& other) noexcept = default;
	ReflectionShader& operator= (const ReflectionShader& other) = default;
	ReflectionShader& operator= (ReflectionShader&& other) noexcept = default;
