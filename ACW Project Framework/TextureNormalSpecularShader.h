...
{
public:
	TextureNormalSpecularShader(ID3D11Device* const device, HWND const hwnd);
	~TextureNormalSpecularShader() override;

	TextureNormalSpecularShader(const TextureNormalSpecularShader& other) = default;
	TextureNormalSpecularShader(TextureNormalSpecularShader&& other) noexcept = default;
	TextureNormalSpecularShader& operator= (const TextureNormalSpecularShader& other) = default;
	TextureNormalSpecularShader& operator= (TextureNormalSpecularShader&& other) noexcept = default;
