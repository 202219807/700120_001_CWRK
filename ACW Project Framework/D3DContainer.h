...
public:
	...
	D3DContainer(const D3DContainer& other) = default;
	D3DContainer(D3DContainer && other) noexcept = default;
	D3DContainer& operator = (const D3DContainer& other) = default;
	D3DContainer& operator = (D3DContainer&& other) noexcept = default;
