...
{
public:
	TextureDisplacement(ID3D11Device* const device, HWND const hwnd);
	~TextureDisplacement() override;

	TextureDisplacement(const TextureDisplacement& other) = default;
	TextureDisplacement(TextureDisplacement&& other) noexcept = default;
	TextureDisplacement& operator= (const TextureDisplacement& other) = default;
	TextureDisplacement& operator= (TextureDisplacement&& other) noexcept = default;
