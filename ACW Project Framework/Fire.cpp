...
void Fire::UpdateFireJetParticleSystem(const float dt)
{
	UpdateParticles(dt);
}

bool Fire::RenderFireJetParticleSystem(ID3D11DeviceContext* const deviceContext, const XMMATRIX& viewMatrix, const XMMATRIX& projectionMatrix, const XMFLOAT3& cameraPosition) const
{
