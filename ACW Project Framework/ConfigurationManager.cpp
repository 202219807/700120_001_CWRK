...
const XMFLOAT3& ConfigurationManager::GetCameraPosition() const
{
	return m_cameraPosition;
}

const XMFLOAT3& ConfigurationManager::GetTerrainDimensions() const
{
	return m_terrainDimensions;
}

const XMFLOAT3& ConfigurationManager::GetTerrainScale() const
{
	return m_terrainScale;
}

const XMFLOAT3& ConfigurationManager::GetRocketPosition() const
{
	return m_rocketPosition;
}

const XMFLOAT3& ConfigurationManager::GetRocketRotation() const
{
	return m_rocketRotation;
}

const XMFLOAT3& ConfigurationManager::GetRocketScale() const
{
	return m_rocketScale;
}

const XMFLOAT4& ConfigurationManager::GetSunAmbient() const
{
	return m_sunAmbient;
}

const XMFLOAT4& ConfigurationManager::GetSunDiffuse() const
{
	return m_sunDiffuse;
}

const XMFLOAT4& ConfigurationManager::GetSunSpecular() const
{
	return m_sunSpecular;
}

const float ConfigurationManager::GetSunSpecularPower() const
{
	return m_sunSpecularPower;
}

const XMFLOAT4& ConfigurationManager::GetMoonAmbient() const
{
	return m_moonAmbient;
}

const XMFLOAT4& ConfigurationManager::GetMoonDiffuse() const
{
	return m_moonDiffuse;
}

const XMFLOAT4& ConfigurationManager::GetMoonSpecular() const
{
	return m_moonSpecular;
}

const float ConfigurationManager::GetMoonSpecularPower() const
{
	return m_moonSpecularPower;
}

const XMFLOAT3& ConfigurationManager::GetLaunchPadScale() const
{
	return m_launchPadScale;
}

const XMFLOAT4& ConfigurationManager::GetLaunchPadTessellationValues() const
{
	return m_launchPadTessellationValues;
}

const XMFLOAT4& ConfigurationManager::GetLaunchPadDisplacementValues() const
{
